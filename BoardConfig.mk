...
TARGET_PREBUILT_KERNEL := device/samsung/zenlteskt/Image
TARGET_PREBUILT_DTB := device/samsung/zenlteskt/dtb.img
...
BOARD_CUSTOM_BOOTIMG_MK :=  device/samsung/zenlteskt/bootimg.mk
...
TARGET_LIBINIT_DEFINES_FILE := device/samsung/zenlteskt/init/init_zenlteskt.cpp
